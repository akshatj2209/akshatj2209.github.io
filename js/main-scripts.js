(function ($) {
    ...
    NUXT.Sidenav = function () {
        ...
        var sidenav = $(".siteSidenav");
        header.on("click", ".button-open-sidenav", function () {
            sidenav.addClass("active");
        });
        sidenav.on("click", ".button-close-sidenav, .sidenavClose, .SidenavMenu a", function () {
    ...
    NUXT.DataFilters = function () {
        var links = $(".dataFiltersLinks");
        links.on("click", "li", function () {
            var links = $(".dataFiltersLinks li");
            var items = $(".dataFiltersItems li");
            ...
            if (filter == "all") {
                ...
                items.hide();
                $(".dataFiltersItems li[data-filter=" + filter + "]").show(600);
            }
        });
    };
    ...
    NUXT.PageScrollEffect = function () {
        ...
        pagepiling.pagepiling({
            menu: ".siteHeader .headerNavigation, .siteSidenav .sidenavNav",
